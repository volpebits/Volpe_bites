  ...
  return (
    <div className="w-full max-w-6xl mx-auto rounded-xl overflow-hidden shadow-lg mt-8 mb-10 relative">
      ...
      >
        ...
        <div className="swiper-button-prev text-white text-3xl absolute top-1/2 left-4 -translate-y-1/2 z-10 cursor-pointer select-none">
          &#10094;
        </div>
        <div className="swiper-button-next text-white text-3xl absolute top-1/2 right-4 -translate-y-1/2 z-10 cursor-pointer select-none">
          &#10095;
        </div>
      </Swiper>
    </div>
