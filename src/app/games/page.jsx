...
export default function Games() {
  ...
  return (
    <div className="w-full overflow-x-hidden">
      {/* Hero Section */}
      <main className="bg-gradient-to-r from-white to-purple-300 text-purple-800 dark:bg-gradient-to-br dark:from-black dark:via-purple-700 dark:to-purple-950 flex flex-col items-center gap-4 sm:gap-6 md:gap-8 lg:gap-10 p-3 sm:p-4 md:p-6 lg:p-8">
        ...
        {/* Video Container */}
        <div className="w-full max-w-xs sm:max-w-sm md:max-w-2xl lg:max-w-4xl xl:max-w-5xl h-[200px] sm:h-[250px] md:h-[350px] lg:h-[450px] xl:h-[500px] 2xl:h-[600px] rounded-lg overflow-hidden shadow-lg sm:shadow-xl border border-black sm:border-2 md:border-4 bg-black relative group sm:mx-4">
      ...
      <div className='min-h-screen bg-gradient-to-r from-purple-400 to-purple-600 dark:bg-gradient-to-br dark:from-black'>
        <div className=''>
          <section className="mb-20 mr-56 ml-56 bg-gradient-to-r from-purple-200 to-purple-400 text-purple-800 dark:bg-gradient-to-br dark:from-purple-950 dark:via-purple-700 dark:to-purple-800 py-16 px-8 rounded-xl">
...
// "use client";
// import { useState, useRef, useEffect } from 'react';
// import gamesData from '../../data/games.js'; // Importa os dados do JSON com o caminho correto
// import GamesCard from '../components/GamesCards.jsx'; // Importa o componente com o caminho correto
...
//   // Lógica de vídeo (mantida do seu código original)
//   const handleVideoError = (e) => {
//     console.error("Erro ao carregar vídeo:", e);
//     setVideoError(true);
//     if (e.target.error) {
...
//       console.error("Mensagem do erro:", errorMessage);
//       switch(errorCode) {
//         case 1: console.error("Download do vídeo foi abortado"); break;
//         case 2: console.error("Erro de rede - vídeo não encontrado"); break;
//         case 3: console.error("Erro de decodificação do vídeo"); break;
//         case 4: console.error("Formato do vídeo não suportado ou arquivo não encontrado"); break;
//         default: console.error("Erro desconhecido:", errorMessage);
//       }
//     }
//   };
...
//     <div className="w-full overflow-x-hidden">
//       {/* Hero Section */}
//       <main className="bg-gradient-to-r from-white to-purple-300 dark:bg-gradient-to-br dark:from-black dark:via-purple-700 dark:to-purple-950 flex flex-col items-center gap-4 sm:gap-6 md:gap-8 lg:gap-10 p-3 sm:p-4 md:p-6 lg:p-8">
//         <div className="text-center max-w-xs sm:max-w-lg md:max-w-2xl lg:max-w-4xl xl:max-w-5xl px-2 sm:px-4">
//           <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-bold mb-3 sm:mb-4 md:mb-6 text-purple-800 dark:text-green-500 leading-tight">
//             HellClock: Reescreva a História na Guerra de Canudos
//           </h1>
...
//           <a
//             href="#"
//             className="px-6 py-3 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-xl shadow-lg transition transform hover:scale-105"
//           >
//             Jogar Agora
//           </a>
//         </div>
//         <div className='font-sans relative grid grid-cols-1 gap-8 px-8 py-16 space-y-6 text-gray-900 max-w-3xl text-2xl ms-8'>
//           <p>Em HellClock você assume o
//             papel de Pajéu, um ex-escravo e guerreiro destemido, determinado a
//             resgatar seu mentor, Antônio Conselheiro, das forças sobrenaturais
//             que assolam a região.

//           </p>
//            <p>
//             Este jogo oferece uma experiência única ao combinar elementos de
//             ARPG com mecânicas de roguelite, proporcionando combates intensos e
//             desafiadores.
//           </p>
//           <p>
//             Com uma narrativa profunda ambientada em uma versão sombria da
//             Guerra de Canudos, os jogadores enfrentarão demônios e criaturas
//             místicas enquanto exploram masmorras traiçoeiras.
//           </p>
//         </div>
//       </main>
...
//       {/* Nova Seção de Outros Jogos */}
//       <div className="bg-white text-gray-800 py-16 px-4">
//         <div className="max-w-7xl mx-auto text-center">
//           <h2 className="text-4xl font-bold mb-12">Outros Jogos</h2>
